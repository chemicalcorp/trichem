...
<div class="container">
    <article style="font-size: 120%; text-align: left; color: black;">
        <h3 style="text-align: left;">Our Strengths</h3>
        <hr/>
        We provide quality products of reputed make from across the globe, with a timely techno- commercial support through a team of, 
        <br/>
        <br/>
        <ul>
            <li>Highly experienced personnel.</li>
            <li>Experienced and skilled manpower</li>       
            <li>Timely supplies from ready stocks.</li>       
            <li>Capacity and infrastructure to cater to Global requirements.</li>       
            <li>Adequate financial strength to meets the business needs.</li>       
        </ul>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        We provide infrastructure and logistics support by way of warehousing facility of nearly 20,000 sq ft of area and have arrangements with various logistics partners to ensure fast and safe movement of goods. With a view to facilitate customer's understanding on a particular product, we furnish documents like COA, MSDS, TDS and other relevant documents on request. This makes the customer thoroughly updated.
        <br/>
        <br/>
        <h3 style="text-align: left;">Our Commitment</h3>
        <hr/>
         We endeavour to be the best company to ‘work for’ and the best company ‘to buy from’ We will do this through:
        <br/>
        <br/>
        <ul>
            <li>Surpassing customers expectations by providing prompt, efficient and better services.</li>
            <li>Building and Maintaining Customer Relationships.</li>
            <li>Conducting our Business with utmost Economy and sound business principles.</li>
        </ul>
    </article>
</div>
